        ...
        <form class="signup-form signupbox" onSubmit={handleSubmit}>
            <div className=' p-5 pb-4 mt-3'>
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div className="form-group mb-3 pt-3">
                            <label htmlFor="gstNumber" className="form-label">GST</label>
                            <input type="text" className="form-control" name="gstNumber" value={credentails.gstNumber} onChange={onchange} placeholder="GST" />                        
                        </div>
                    </div>
                </div>
