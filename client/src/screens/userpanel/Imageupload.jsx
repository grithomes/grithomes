...
export default function Imageupload() {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/updatesignupdatadata/${userid}`, {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': authToken,
        ...
        <div className='w-full '>
            <div className="flex flex-col md:flex-row">
                    ...
                    <div className='mx-4 my-5'>
                        ...
                        <section className='card-standard rounded adminborder p-6 m-2 mb-8'>
                            <form>
                                <div className=' p-8 pb-4 mt-6'>
                                    <p className='text-xl font-semibold font-semibold'>Edit Profile</p>
                                    ...
                                    <div className="flex flex-col md:flex-row">
                                        ...
                                        <div className="w-full px-2 w-full px-2 w-full md:w-1/2 px-2 w-full lg:w-1/2 px-2">
                                            <div className="form-group mb-6 pt-4">
                                                ...
                                                <textarea type="message" className="input-standard" name="address" value={signupdata.address} onChange={handleInputChange} placeholder="Address" id="exampleInputaddress" />
                                            </div>
                                        </div> */}
                                    </div>
                                    <button type="button" className='btn btnclr text-white mr-2' onClick={handleSaveClick}>Save</button>
                                </div>
                            </form>
                        </section>
                    </div>
