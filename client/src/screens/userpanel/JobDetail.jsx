                            ...
                            <div className='flex items-center justify-between py-4 px-6 bg-white shadow-sm rounded-t-xl border border-gray-100 flex-shrink-0'>
                                <div>
                                    <div className="flex items-center gap-3">
                                        <button onClick={() => navigate('/userpanel/JobsList')} className="text-gray-400 hover:text-primary transition-colors">
                                ...
                                <div className="text-right hidden md:block">
                                    <p className="text-sm font-medium text-gray-600"><i className="fa-solid fa-users mr-2 text-primary"></i>{job?.assignedTeamMembers?.length || 0} Members</p>
                                    {job?.invoiceId && <span className="text-xs mt-1 inline-block bg-green-50 text-green-700 px-2 py-0.5 rounded border border-green-100">Linked to Invoice</span>}
                                </div>
                            </div>
