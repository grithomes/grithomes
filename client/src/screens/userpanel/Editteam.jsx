...
export default function Editteam() {
    ...
    const fetchteamData = async () => {
        try {
            ...
            const response = await fetch(`https://grithomes.onrender.comapi/getteamdata/${teamid}`, {
                headers: {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://grithomes.onrender.comapi/updateteamdata/${teamid}`, {
                method: 'POST',
                headers: {
