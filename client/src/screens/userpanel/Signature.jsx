        ...
        if (!sigCanvas.current.isEmpty()) {
            ...
            try {
                ...
                if (json.hasSignature) {
                    ...
                    const updateResponse = await fetch('https://grithomes.onrender.comapi/update-ownersignature', {
                        method: 'PUT',
                        headers: {
                    ...
                    const createResponse = await fetch('https://grithomes.onrender.comapi/ownersignature', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': localStorage.getItem('authToken'),
