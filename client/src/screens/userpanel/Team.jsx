...
export default function Team() {
    ...
    const fetchdata = async () => {
        try {
            ...
            const response = await fetch(`https://grithomes.onrender.comapi/teammemberdata/${userid}`, {
                headers: {
    ...
    const handleDeleteClick = async (teamid) => {
        try {
            const authToken = localStorage.getItem('authToken');
            const response = await fetch(`https://grithomes.onrender.comapi/delteammember/${teamid}`, {
                method: 'GET',
                headers: {
                    'Authorization': authToken,
                  }
