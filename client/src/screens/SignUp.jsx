...
export default function SignUp() {
  ...
  const [addedCompanyPhotos, setCompanyAddedPhotos] = useState([]);
    ...
    const handleSubmit = async (e) => {
        ...
        // const companyUploadResponse = await fetch("https://grithomes.onrender.comapi/upload-image", {
        // method: 'POST',
        ...
        const response = await fetch("https://grithomes.onrender.comapi/createuser", {
          method: 'POST',
          headers: {
